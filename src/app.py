...
df = pd.read_csv('/workspace/Logistic_Regression_Project_Tutorial/data/processed/df_processed.csv')
...
filename = '/workspace/Logistic_Regression_Project_Tutorial/models/model_logisticReg.sav'
